...
function addInfoUser(user) {
    ...
    <table>
        ...
        <tr>
            ...
            <td> <input type="text" value="` + numToString(tongTienTatCaDonHang) + `VNĐ" readonly> </td>
            <td></td>
        </tr>
        <tr>
        <td>Tổng SOl đã mua: </td>
        <td> <input type="text" value="` + numToString(tongTienTatCaDonHang / (1.0*4000000)) + ` SOL" readonly> </td>
        <td></td>
    </tr>
        <tr>
...
function addDonHang(dh) {
    ...
    s += `
                <tr style="font-weight:bold; text-align:center; height: 4em;">
                    ...
                    <td class="alignRight">` + numToString(totalPrice / (1.0*4000000)) + ` SOL</td>
                    <td > ` + dh.tinhTrang + ` </td>
                </tr>
            </table>
            <hr>
